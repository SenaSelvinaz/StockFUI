...
class PaketlemeGoreviPage extends StatefulWidget {
  const PaketlemeGoreviPage({super.key});

  @override
  State<PaketlemeGoreviPage> createState() => _PaketlemeGoreviPageState();
}

class _PaketlemeGoreviPageState extends State<PaketlemeGoreviPage> {
  static const Color primaryBlue = Color.fromARGB(255, 11, 26, 94);

  final TextEditingController paketlemeController = TextEditingController();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _label("Paketleme Yapılan Adet"),
            _numberField(paketlemeController),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items: const [
            DropdownMenuItem(
              value: "Paketleme Hatası",
              child: Text("Paketleme Hatası"),
            ),
            DropdownMenuItem(
              value: "Ölçü Hatası",
  ...
  void _handleSubmit() {
    if (paketlemeController.text.isEmpty ||
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text("Paketlenen Adet: ${paketlemeController.text}"),
