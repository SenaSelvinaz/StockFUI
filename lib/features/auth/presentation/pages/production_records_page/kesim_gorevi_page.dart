...
class KesimGoreviPage extends StatefulWidget {
  const KesimGoreviPage({super.key});

  @override
  State<KesimGoreviPage> createState() => _KesimGoreviPageState();
}

class _KesimGoreviPageState extends State<KesimGoreviPage> {
  static const Color primaryBlue = Color.fromARGB(255, 11, 26, 94);

  final TextEditingController kesimController = TextEditingController();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _label("Kesim Yapılan Adet"),
            _numberField(kesimController),
  ...
  void _handleSubmit() {
    if (kesimController.text.isEmpty ||
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text("Kesilen Adet: ${kesimController.text}"),
  ...
  void _saveRecord() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text("Kesim kaydı başarıyla oluşturuldu."),
        backgroundColor: Colors.green,
      ),
    );

    kesimController.clear();
