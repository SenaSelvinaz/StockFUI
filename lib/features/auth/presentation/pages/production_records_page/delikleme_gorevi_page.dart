...
class DeliklemeGoreviPage extends StatefulWidget {
  const DeliklemeGoreviPage({super.key});

  @override
  State<DeliklemeGoreviPage> createState() => _DeliklemeGoreviPageState();
}

class _DeliklemeGoreviPageState extends State<DeliklemeGoreviPage> {
  static const Color primaryBlue = Color.fromARGB(255, 11, 26, 94);

  final TextEditingController deliklemeController = TextEditingController();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _label("Delikleme Yapılan Adet"),
            _numberField(deliklemeController),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items: const [
            DropdownMenuItem(
              value: "Delikleme Hatası",
              child: Text("Delikleme Hatası"),
            ),
            DropdownMenuItem(
              value: "Ölçü Hatası",
  ...
  void _handleSubmit() {
    if (deliklemeController.text.isEmpty ||
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text("Deliklenen Adet: ${deliklemeController.text}"),
